...
namespace Xacml
{
    public static class Constants
    {
        ...
        {
            private static readonly string AttributeCategory = V3 + "attribute-category:";
            public static readonly string Resource = AttributeCategory + "resource";
            public static readonly string Action = AttributeCategory + "action";
